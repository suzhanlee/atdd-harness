# Apple IAP Subscription - Cucumber Feature File
# Auto-generated from ATDD Gherkin Phase

Feature: Apple In-App Purchase Subscription Management
  사용자가 애플 인앱 결제로 구독 상품을 구매하고 관리하는 기능
  ...
  @happy @grace_period_expired @event
  ...
  @happy @non_renewing_expire @event
