...
### Phase 0: ATDD
ATDD 파이프라인 진입점. `/interview`를 실행하고 완료 후 Stop Hook가 자동으로 `/validate`를 트리거.
...
### Phase 2.6: Red Team Design
도메인 모델(Entity, VO, Aggregate)을 RRAIRU 관점에서 비판적 검토.
...
```bash
# 0. ATDD 파이프라인 진입점 (또는 /interview부터 시작)
/atdd
